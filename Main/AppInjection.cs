    ...
    configuration["Environment:PAYOS_CHECKSUM_KEY"] ?? throw new Exception("Cannot find PAYOS_CHECKSUM_KEY")
          ...
          .AddJwtBearer(options =>
          {
            ...
            services.AddCors(options =>
            {
                ...
                {
                    policy
                        .WithOrigins("http://localhost:5173", "https://exeskincare.onrender.com", "https://192.168.1.9:5173", "https://localhost:5173", "https://exe201-skincare-fe-new.onrender.com", "https://exe201skincarefenew.vercel.app")
                        .AllowAnyHeader()
                        .AllowAnyMethod()
                        .AllowCredentials();
                });
